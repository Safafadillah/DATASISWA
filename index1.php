...
<body>
    ...
    <button type="submit" name="kirim" value="cetak"><i class='bx bxs-printer'></i><a href="index2.php">CETAK</a></button>
    <button type="submit" name="hapus" value="hapus"><i class='bx bxs-trash'></i><a href="index3.php">HAPUS DATA</a></button>
